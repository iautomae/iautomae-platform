            ...
            <div className="prose prose-invert max-w-none space-y-12 text-slate-300 leading-relaxed font-light">
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">01.</span> Objeto del Servicio y Aceptación
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">02.</span> Propiedad Intelectual e Industrial
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">04.</span> Disponibilidad y Acuerdo de Nivel de Servicio (SLA)
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">05.</span> Uso Ético y Conducta Prohibida
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">06.</span> Suscripciones, Pagos y Facturación
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">07.</span> Confidencialidad Corporativa
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">08.</span> Jurisdicción y Resolución de Conflictos
                    </h2>
                    <p>
