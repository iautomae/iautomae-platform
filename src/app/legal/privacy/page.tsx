            ...
            <div className="prose prose-invert max-w-none space-y-12 text-slate-300 leading-relaxed font-light">
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">01.</span> Identidad y Responsabilidad
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">02.</span> Naturaleza de la Información Recopilada
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">03.</span> Finalidad Estratégica del Tratamiento
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">04.</span> Procesamiento mediante Inteligencia Artificial
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">05.</span> Transferencia Internacional de Datos
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">06.</span> Seguridad y Medidas de Cifrado
                    </h2>
                    <p>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">07.</span> Derechos del Titular (Derechos ARCO)
                    </h2>
                    <p>
                        Usted podrá ejercer en cualquier momento sus derechos de Acceso, Rectificación, Cancelación y Oposición (ARCO). Para solicitar el retiro de su consentimiento o la eliminación de información sensible de nuestros sistemas de procesamiento por IA, envíe una solicitud formal a <span className="text-brand-mint">admin@iautomae.com</span>. Atenderemos su requerimiento dentro de los plazos legales establecidos por la Autoridad Nacional de Protección de Datos Personales.
                    </p>
                </section>

                <section className="space-y-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] flex items-center gap-3">
                        <span className="text-brand-mint">08.</span> Actualizaciones de la Política
                    </h2>
                    <p>
