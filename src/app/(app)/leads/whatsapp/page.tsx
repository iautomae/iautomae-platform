            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-6">
                    <div className="card-professional p-8 space-y-8">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="flex gap-4">
                                    <div className="w-8 h-8 rounded-full bg-brand-turquoise/10 text-brand-turquoise flex items-center justify-center font-bold text-sm shrink-0">
                                        {item.step}
                                    </div>
                                    <div>
                        ...
                        <button className="w-full py-4 bg-brand-turquoise text-white rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-brand-turquoise-dark transition-all shadow-lg shadow-brand-turquoise/20">
                ...
                <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3 text-xs text-gray-700">
                                    <item.icon size={16} className="text-brand-turquoise" />
                                    {item.text}
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 space-y-3">
                        ...
                        <button className="text-xs font-bold text-brand-turquoise hover:underline">Ver guía oficial</button>
                    </div>
                </div>
            </div>
        </div>
