        ...
        <div className="min-h-screen bg-slate-50/50 p-8 ml-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Total Clientes</p>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Planes Activos</p>
                        <p className="text-2xl font-bold text-slate-900">{clients.filter(c => c.role !== 'admin').length}</p>
                    </div>
                </div>
            </div>
